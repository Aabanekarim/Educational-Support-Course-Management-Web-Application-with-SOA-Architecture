...
<section class="teachers">
   ...
   <div class="box-container">
      ...
      <%List<annonce> l=s.listeanouncep(p.getId()); 
	  for(annonce e : l){%>
      ...
      <div class="box">
         ...
         <a href="modifierannonce.jsp?ida=<%=e.getId() %>" class="inline-btn"><i class="fas fa-pen"></i>modifier</a>
         <a href="../traiter?fval=deleteannonce&ida=<%=e.getId() %>" class="inline-btn"><i class="fas fa-trash"></i>supprimer</a>
         <a href="../traiter?fval=abscence&ida=<%=e.getId() %>" class="inline-btn"><i class="fas fa-empty"></i>absence</a>
