...
<div class="side-bar">
   ...
   <nav class="navbar">
      <a href="accueil.jsp"><i class="fas fa-home"></i><span>home</span></a>
      <a href="../traiter?fval=monannonce&id=<%=u.getId() %>"><i class="fas fa-question"></i><span>Mes Annonces</span></a>
      <a href="consultemp.jsp"><i class="fas fa-graduation-cap"></i><span>Emploi de temps</span></a>
      <a href="chercherannonce.jsp"><i class="fas fa-chalkboard-user"></i><span>chercher annonce</span></a>
   </nav>
