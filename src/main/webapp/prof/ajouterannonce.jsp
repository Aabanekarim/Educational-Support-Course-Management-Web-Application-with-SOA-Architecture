...
sess.setAttribute("fval", "ajouterannonce");%>
...
<section class="form-container">
   ...
   <form action="../traiter" method="post" >
      ...
      <p>Matier</p>
      <input type="text" name="matier" placeholder="entrer la matiere" maxlength="50" class="box" required="required">
      <p>Niveau</p>
      <select class="box" name="niveau" aria-label="Default select example">
                      <option value="1er annee" selected>1er annee</option>
      ...
      <p>Filiere</p>
      <input type="text" name="filiere" placeholder="entrer la filiere" maxlength="20" class="box" required="required">
      <p>Classe</p>
      <select class="box" name="classe" aria-label="Default select example" required="required">
                      <option value="primaire" selected="selected"> primaire</option>
                      <option value="college">college</option>
                      <option value="lycee">lycee</option>
                    </select>
      <p>Prix</p>
      <input type="number" name="prix" maxlength="20" class="box" required="required">
      <p>Temps</p>
      <input type="time" name="time" class="box" required="required">
      <p>lundi    <input class="box" type="checkbox" name="jour" value="lundi" id="gridCheck1"></p>
      <p>mardi    <input class="box" type="checkbox" name="jour" value="mardi" id="gridCheck1"></p>
      <p>mercredi    <input class="box" type="checkbox" name="jour" value="mercredi" id="gridCheck1"></p>
      <p>jeudi    <input class="box" type="checkbox" name="jour" value="jeudi" id="gridCheck1"></p>
      <p>vendredi    <input class="box" type="checkbox" name="jour" value="vendredi" id="gridCheck1"></p>
      <p>samedi    <input class="box" type="checkbox" name="jour" value="samedi" id="gridCheck1"></p>
                      
      <input type="submit" value="ajouterannonce" name="fval" class="btn">
   </form>
