...
sess.setAttribute("fval", "ajouterprof");
	String testpass=(String)sess.getAttribute("testpass");
	%>
...
<section class="form-container">
   ...
   <form action="../traiter" method="post" >
      ...
      <p>Nom</p>
      <input type="text" name="nom" placeholder="entrer le nom" maxlength="50" class="box" required="required">
      <p>Prenom</p>
      <input type="text" name="prenom" placeholder="entrer le prenom"  maxlength="50" class="box" required="required">
      <p>Mot de pass</p>
      <input type="password" name="pass" placeholder="entrer mot de pass" maxlength="50" class="box" required="required">
      <p>Confirmer Mot de pass</p>
      <input type="password" name="pass2" placeholder="confirmer mot de pass" maxlength="50" class="box" required="required">
      
                      
      <input type="submit" value="ajouterprof" name="fval" class="btn">
      <%if(testpass!=null){ %>
                <p><%=testpass %></p>
                <%} %>
