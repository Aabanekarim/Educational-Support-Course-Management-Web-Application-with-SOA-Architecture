...
school s=new school();
sess.setAttribute("fval", "ajouterclasse");
...
<section class="form-container">
   ...
   <form action="../traiter" method="post" >
      ...
      <p>Matier</p>
      <input type="text" name="matier" maxlength="50" class="box" required="required">
      <p>Niveau</p>
      <select class="box" name="niveau" aria-label="Default select example">
                      <option value="1er annee" selected="selected">1er annee</option>
      ...
      <p>Filiere</p>
      <input type="text" name="filiere"  maxlength="20" class="box" required="required">
      <p>Classe</p>
      ...
      <input type="submit" value="ajouterclasse" name="fval" class="btn">
      <%if(testpass!=null){ %>
                <p><%=testpass %></p>
                <%} %>
