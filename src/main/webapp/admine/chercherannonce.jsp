...
<section class="teachers">
   ...
   <h1 class="heading">gestion de paiement</h1>
   ...
   <% if(classe==null){ %>
      ...
      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=1er annee" style="text-decoration: none;">1er annee</a></p>
         </div>
      </div>

      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=2eme annee" style="text-decoration: none;">2eme annee</a></p>
         </div>
      </div>

      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=3eme annee" style="text-decoration: none;">3eme annee</a></p>
         </div>
      </div>
      <%} else { %>
      ...
      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=4eme annee" style="text-decoration: none;">4eme annee</a></p>
         </div>
      </div>

      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=5eme annee" style="text-decoration: none;">5eme annee</a></p>
         </div>
      </div>

      <div class="box">
         <div>
            <p><a href="gestiondepaiment.jsp?classe=<%=classe %>&niveau=6eme annee" style="text-decoration: none;">6eme annee</a></p>
         </div>
      </div>
      <%} }%>
